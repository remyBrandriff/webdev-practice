...
<td width=498 valign=top bgcolor=#A31621>
  <table width=100%>
    ...
    $date = (date("Y-m-d", $time));
      ...
      //if vflag is still true and nothing has gone wrong, proceed.
      if ($vflag == true) {
        ...
        /*echo "NOTE: This is a test, haven't done most of the variables correctly
              at this point. Errors are expected.\n"; */
        //echo complete form
        /* TO: My e-mail address
           FROM: User's e-mail address
           CC: User's e-mail address
           SUBJECT: Subject field
           BODY:
                Category: drop-down menu value
                Message: Message from textarea
                Date sent: Timestamp
                */
        ...
        //drop down menu for message type
        echo " <div id='options'>
